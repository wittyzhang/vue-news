...
// webpack-dev-middleware使用compiler对象来对应的文件进行编译和绑定
...
// proxy api requests
// 将proxyTable中的代理请求配置挂到express服务器上
...
//应用的地址信息 eg:http://localhost:8080
var uri = 'http://localhost:' + port

// webpack开发中间件合法（valid）之后输出提示语到控制台，标明服务器已启动
